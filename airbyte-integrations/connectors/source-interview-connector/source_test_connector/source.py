...
from typing import Dict, Generator, Any, Mapping
...
class SourceTestConnector(Source):
    ...
    def read(
        ...
        for i in range(resourcesNumber):
            logger.info("Start Extracting Data from " +
                        "test_resource_" + str(i) + "resource.")
            ...
            for y in range(recordsPerResource):
                ...
                if (y == recordsPerResource-1):
                    logger.info("Number of records extracted for "+"test_resource_" +
                                str(i)+" resource: "+str(recordsPerResource))
        logger.info("Total resources: " + str(resourcesNumber))
        logger.info("Records per resource: " + str(recordsPerResource))
        logger.info("Total extracted records: " +
                    str(resourcesNumber * recordsPerResource))
